...
/*
#1 main.sample input :
enter the main.Array size
        5
        1 7 2 3 4
        delete index or value
        7
        1 2 3 4
        main.Array is increse order
 #2
enter the main.Array size
5
6 4 2 1 6
...
2
 6 4 1 6
 main.Array is Not increse order
...
public class arrayincreseordecrese {
    ...
    public static void main(String args[])
    {
        ...
        if(count == n-1)
        {
            System.out.println(" main.Array is increse order  ");
        }
        else
        {
            System.out.println(" main.Array is Not increse order  ");
        }
    }
}

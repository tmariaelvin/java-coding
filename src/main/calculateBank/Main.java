package main.calculateBank;//public class part2.Main {
//    public static void main(main.String[] args) {

////        //main.simple variables
...
//
//        main.String mortgageFormatted = NumberFormat.getCurrencyInstance().format(mortgage);
//        System.out.println("Mortgage: " + mortgageFormatted);
//
//        //for loop
//
//        main.String value = "Hello World";
//
//        for (int i= 0; i< 5; i++){
...
//        var main.employee = new practice.Employee(50_000, 20);
//        practice.Employee.printNumberOfEmployees();
//        int wage = main.employee.calculateWage();
//        System.out.println(wage);

//          var main.employee = new practice.Employee();
//          main.employee.baseSalary = 50000;
//            main.employee.setBaseSalary(50_000);
////            main.employee.getBaseSalary();
//            main.employee.setHourlyRate(20);
//            int wage = main.employee.calculateWage(5);
//            int wage1 = main.employee.calculateWage(0);
//        System.out.println(wage);
...
//
//        Scanner scanner = new Scanner(new File("/home/spurge/Downloads/bank-data-main.simple.csv"));
//
//
...
//        Map<main.String, Integer> map = new HashMap<>();
//        while (scanner.hasNextLine()) {
//            main.String[] data = scanner.nextLine().split(",");

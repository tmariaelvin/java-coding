...
public class EmployeeManagementSystem {
    ...
    public static void main(String[] args) {
        EmployeeManagementSystem empMgmSystem = new EmployeeManagementSystem();
        ...
        if(args.length != 1) {
            ...
            if(empMgmSystem.empExists(emp_id)) {
                System.out.println("Emp No.    Emp Name    Department    Designation    Salary");
                System.out.printf("%7d    ", emp_id);
                System.out.printf("%8s    ", empMgmSystem.getName(emp_id));
                System.out.printf("%10s    ", empMgmSystem.getDept(emp_id));
                System.out.printf("%11s    ", empMgmSystem.getDesignation(emp_id));
                System.out.printf("%6d\n", empMgmSystem.getSalary(emp_id));
            }
            else {
                System.out.println("There is no main.employee with empid: " + emp_id);
            }
        }
    }
}
